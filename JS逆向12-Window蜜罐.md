...
这里首先我们讲一下什么是window蜜罐

window蜜罐特点：抠下来的代码放在Pycharm当中运行卡死，而且会不断的吃内存，是因为进入到了window蜜罐当中。实现的方式有两个可能性：**浏览器指纹、格式化检测。**我们新打开一个浏览器标签将抠下来的JS代码放入Console里，如果运行卡死或报错，通常是格式化检测，反之就是浏览器指纹。

?> 提示：格式化检测通常会用到"toString"方法，最笨最扎实的方法就是：新打开一个浏览器标签将代码放入Console里，在第一行写上debugger再运行一步步调试，直到卡死的那一行代码。
...
btoa = function (e) {var t = u, r = {};r.TGmSp = t(244) + "ARACTER_ERR",r[t(238)] = t(224) + t(250) + "/",r[t(205)] = "^([^ ]+( +" + t(230) + t(259),r.aYkvo = function (e) {return e()},r[t(254)] = function (e, t) {return e % t},r.evetF = function (e, t) {return e >> t},r.GfTek = t(196),r[t(260)] = function (e, t) {return e << t},r[t(229)] = function (e, t) {return e | t},r[t(242)] = function (e, t) {return e << t},r[t(228)] = function (e, t) {return e & t},r[t(207)] = function (e, t) {return e << t},r[t(202)] = function (e, t) {return e & t},r.jdwcO = function (e, t) {return e === t},r.kPdGe = t(231),r[t(195)] = t(213),r[t(201)] = function (e, t) {return e & t},r[t(206)] = function (e, t) {return e == t},r[t(219)] = function (e, t) {return e + t},r[t(220)] = function (e, t) {return e(t)};var i = r;if (/([^\u0000-\u00ff])/.test(e))throw new Error(i.TGmSp);for (var o, a, s, l = 0, c = []; l < e[t(261)];) {switch (a = e[t(237)](l),s = i.kukBH(l, 6)) {case 0:c[t(246)](f[t(245)](i[t(212)](a, 2)));break;case 1:"WhHMm" === i[t(198)] || n.g && c[t(246)](f[t(245)](i.pHtmC(2 & o, 3) | i.evetF(a, 4)));break;case 2:c[t(246)](f[t(245)](i[t(229)](i[t(242)](15 & o, 2), i.evetF(a, 6)))),c[t(246)](f[t(245)](i[t(228)](a, 63)));break;case 3:c[t(246)](f[t(245)](i[t(212)](a, 3)));break;case 4:c.push(f[t(245)](i[t(229)](i[t(207)](i.OWUOc(o, 4), 6), i[t(212)](a, 6))));break;case 5:c[t(246)](f[t(245)](i[t(229)](i[t(207)](i[t(202)](o, 15), 4), a >> 8))),c.push(f.charAt(i[t(202)](a, 63)))}o = a,l++}return 0 == s ? i[t(226)](i[t(241)], i[t(195)]) || (c[t(246)](f[t(245)](i[t(201)](o, 3) << 4)),c.push("FM")) : i.eMnqD(s, 1) && (c[t(246)](f[t(245)]((15 & o) << 2)),c[t(246)]("K")),i[t(219)](i.aQCDK(d(15), md5(c[t(234)](""))), i[t(220)](d, 10))};
...
o = function (e, t) {return _0x32a1[e -= 492]};
...
var r = {};
r.m = t[e(528)](btoa, p_s);
r.t = p_s;

m = function(){return 'm='+r.m+'&t='+r.t};
```
...
for page in range(1, 6):
    ...
    m = JsObj.call('m')
    # 接口地址
    url = f'https://match.yuanrenxue.com/api/match/16?page={page}&{m}'
    # 输出响应
