...
cookie_value = JsObj.call('cookie')
get_value = JsObj.call('get')

# 更新请求头
headers.update({'cookie':f'{cookie_value};sessionid=6aj4prfedvo97clfs83chzif0ukpdr8p'})
print(headers)
# 数值
values = 0
...
for page in range(1, 6):
    # 接口地址
    url = f'https://match.yuanrenxue.com/api/match/5?page={page}{get_value}'
    print(url)
    # 输出响应
